...
% Saving options
outputfile = 'myTraj_vbSPT.mat';
jobID = 'MsSlice_20250421_8_left';
...
init_D = [0.1, 10];   % interval for diffusion constant initial guess [length^2/time] in same length units as the input data.
